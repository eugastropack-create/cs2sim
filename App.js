    ...
    <SafeAreaView style={s.container}>
      ...
      <View style={[s.utilityBar, isNarrow ? s.utilityBarNarrow : s.utilityBarWide]}>
        ...
        <View style={[s.utilityRow, isNarrow ? s.utilityRowNarrowSecond : s.utilityRowWideRight]}>
          ...
          <TouchableOpacity
            ...
            onPress={event => { event.preventDefault?.(); setBlogSection('about'); switchTab('blog'); }}
          >
      ...
      {!compact && (
        <View style={s.footerBar}>
          <TouchableOpacity href={`/guides/${lang}/privacy.html`} onPress={event => { event.preventDefault?.(); setBlogSection('privacy'); switchTab('blog'); }}>
            <Text style={s.footerBarLink}>{t('footer.privacy')}</Text>
          </TouchableOpacity>
          <Text style={s.footerBarSep}>·</Text>
          <TouchableOpacity href={`/guides/${lang}/contact.html`} onPress={event => { event.preventDefault?.(); setBlogSection('contact'); switchTab('blog'); }}>
            <Text style={s.footerBarLink}>{t('footer.contact')}</Text>
          </TouchableOpacity>
          <Text style={s.footerBarSep}>·</Text>
          <TouchableOpacity href={`/guides/${lang}/about.html`} onPress={event => { event.preventDefault?.(); setBlogSection('about'); switchTab('blog'); }}>
