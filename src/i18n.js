...
const DICT = {
  ...
  // ==========================================================
  en: {
    'tradeup.showMore': 'Show more outcomes ({n} remaining)',
    'tradeup.regular': "Regular · tap for StatTrak™",
    'tradeup.added': "{name} added to contract.",
    'tradeup.full': "No empty slots.",
    'tradeup.uncertain': "Estimate: this contract includes old, modelled or unverified prices. Edit the prices before comparing profit. Fees and float/pattern premiums are excluded.",
    'tradeup.priceNote': "USD reference prices. Profit is before marketplace fees; actual sale prices and float premiums may differ.",
    'prices.title': "Price data · {source}",
    'prices.date': "Source snapshot: {date}",
    'prices.warning': "Some prices are old, estimated or unverified. A recent download does not mean every item price is current.",
    'prices.none': "Market data unavailable — simulated estimates are being used.",
    'prices.basis': "USD reference values, not guaranteed Steam sale prices.",
    // --- Üst yardımcı çubuk ---
    ...
    'util.modeHint': 'Click to switch between Wallet Mode (balance is spent) and Unlimited Mode (nothing is charged).',
    'util.theme': 'Theme',
    ...
    'common.spent': 'Spent',
    'common.won': 'Won',
    'common.totalOpened': 'Total Opened',
    'common.totalSpent': 'Total Spent',
    'common.totalWon': 'Total Returned',
    'common.resetStats': 'Reset',
    'common.searchInCategory': 'Search in this category…',
    'search.items': 'Items',
    'search.containers': 'Cases & Containers',
    'lookup.pricesByWear': 'Price by wear',
    'lookup.noWear': 'This item has no wear variants.',
    'lookup.floatRange': 'Float range: {min} – {max}',
    'lookup.dropsFrom': 'drops from {n}',
    'lookup.noContainer': 'Not obtainable from any container in this simulator.',
    'lookup.simulated': '~ Simulated price — no live market listing found for this item.',
    'tradeup.editPrice': 'Click to enter the price you actually paid',
    'tradeup.editPriceOut': 'Click to enter the price you would actually sell at',
    'contents.noMatch': 'No item in this category matches your search.',
    'contents.matches': 'matches',
    ...
    'tradeup.knifeRecipe': '5× Covert',
    'tradeup.knifeRecipeBody': "Only knives/gloves linked to the input cases are included. StatTrak contracts exclude gloves. Probabilities are a model; individual patterns are not priced.",
  ...
  // ==========================================================
  tr: {
    'tradeup.showMore': 'Daha fazla sonuç göster ({n} kaldı)',
    'tradeup.regular': "Normal · StatTrak™ için dokun",
    'tradeup.added': "{name} sözleşmeye eklendi.",
    'tradeup.full': "Boş yuva kalmadı.",
    'tradeup.uncertain': "Tahmini hesap: bu sözleşmede eski, modellenmiş veya doğrulanamayan fiyatlar var. Kâr karşılaştırmadan önce fiyatları düzenleyin. Komisyon ve float/desen primleri dahil değildir.",
    'tradeup.priceNote': "USD referans fiyatları. Kâr komisyon öncesidir; gerçek satış fiyatı ve float primleri farklı olabilir.",
    'prices.title': "Fiyat verisi · {source}",
    'prices.date': "Kaynak tarihi: {date}",
    'prices.warning': "Bazı fiyatlar eski, tahmini veya doğrulanmamış olabilir. Yeni indirme tarihi her eşyanın fiyatının güncel olduğu anlamına gelmez.",
    'prices.none': "Piyasa verisi alınamadı — simüle tahminler kullanılıyor.",
    'prices.basis': "USD referans değerleridir; Steam satış fiyatı garantisi değildir.",
    ...
    'util.language': 'Dil',
    'util.modeHint': 'Cüzdan Modu (bakiyeden düşer) ile Sınırsız Mod (hiçbir şey tahsil edilmez) arasında geçiş yapmak için tıklayın.',
    'util.theme': 'Tema',
    ...
    'common.totalOpened': 'Toplam Açılan',
    'common.totalSpent': 'Toplam Harcanan',
    'common.totalWon': 'Toplam Gelen',
    'common.resetStats': 'Sıfırla',
    'common.searchInCategory': 'Bu kategoride ara…',
    'search.items': 'Eşyalar',
    'search.containers': 'Kasalar & Kutular',
    'lookup.pricesByWear': 'Aşınmaya göre fiyat',
    'lookup.noWear': 'Bu eşyanın aşınma çeşidi yok.',
    'lookup.floatRange': 'Float aralığı: {min} – {max}',
    'lookup.dropsFrom': '{n} kutudan çıkar',
    'lookup.noContainer': 'Bu simülatörde hiçbir kutudan çıkmıyor.',
    'lookup.simulated': '~ Simüle fiyat — bu eşya için canlı piyasa kaydı bulunamadı.',
    'tradeup.editPrice': 'Gerçekte ödediğiniz fiyatı girmek için tıklayın',
    'tradeup.editPriceOut': 'Gerçekte satacağınız fiyatı girmek için tıklayın',
    'contents.noMatch': 'Bu kategoride aramanızla eşleşen eşya yok.',
    'contents.matches': 'eşleşme',
    ...
    'tradeup.knifeRecipe': '5× Covert',
    'tradeup.knifeRecipeBody': "Yalnızca girdilerin kasalarına bağlı bıçak/eldivenler dahildir. StatTrak sözleşmelerinde eldiven bulunmaz. Olasılıklar bir modeldir; özel desenler fiyatlanmaz.",
